<?php
	...
	$retval .= "</div>";
    $retval .= "<hr/>";
    $retval .= "<div class='orgboxdivcontent'>";
	$retval .= "<ol class='orgboxitems' id='orgboxitems".$obid."' box='".$obid."'>";
	$retval .= "<li class='orgboxitemnew'><div> Drag text here to add a new item or <button id='new_obi_button' box='".$obid."' class='new_obi_button' onclick='createobi(".$obid.")'>Manually Create Item</button> </div></li>"; 
	$retval .= "</ol>";
	$retval .= "</div>";
