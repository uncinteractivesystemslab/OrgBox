<script type="text/javascript">
   ...
   function saveobiremove(obiid, obid, obisubitems)
   {
...
<?php
   ...
   $echoText .= "<button id='save_obi_button' onclick='saveobiremove(".$obiid.", ".$obid.", \"$obisubitems\")' class='savebutton'>Delete</button>";
